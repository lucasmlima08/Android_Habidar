...
public class GenerateCalculation {

    public String stringCalculation = ""; // Formatação do cálculo na tela.
    public String stringCalculationHide = ""; // Formatação do cálculo escondido na tela.
    ...
    private void processCalculate(int[] numbers, char[] arithmetics, int type){
        ...
        String[] numberStrOrigin = new String[3];
        ...
        if (type == 1){
            ...
            // Backup dos números.
            numberStrOrigin = numberStr.clone();
            // Esconde os dígitos.
        ...
        String string = "";
        for (int i = 0; i < numbers.length; i++) {
            stringHide += i == 0 ? numberStr[0] : " " + arithmetics[i - 1] + " " + numberStr[i];
            string += i == 0 ? numberStrOrigin[0] : " " + arithmetics[i - 1] + " " + numberStrOrigin[i];
        }
        stringHide += type != 5 ? " = " + this.resultCalculate : " = " + "??";
        string += " = " + this.resultCalculate;
        // Inclui strings.
        this.stringCalculationHide = stringHide;
        this.stringCalculation = string;
    }
